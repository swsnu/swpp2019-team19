...
export const clearArticle = () => (dispatch) => dispatch({ type: CLEAR_ARTICLE });
...
export const fetchAllBoard = (articleCount, tag) => (dispatch) => axios
  .post('/api/boards/', {
    tag,
...
export const clearAllBoard = () => (dispatch) => dispatch({ type: CLEAR_ALL_BOARD });

export const fetchHotBoard = (articleCount, tag) => (dispatch) => axios
  .post('/api/boards/', {
    tag,
    article_count: articleCount,
    board_name: 'hot',
...
export const clearHotBoard = () => (dispatch) => dispatch({ type: CLEAR_HOT_BOARD });

export const fetchArticleList = (articleCount, boardName, tag) => (dispatch) => axios
  .post('/api/boards/', {
    tag,
    article_count: articleCount,
...
export const clearArticleList = () => (dispatch) => dispatch({ type: CLEAR_ARTICLE_LIST });
