...
export const SIGN_UP_CREATE_FAIL = 'SIGN_UP_CREATE_FAIL';
export const SIGN_UP_SUBMIT_FAIL = 'SIGN_UP_SUBMIT_FAIL';
...
export const EDIT_ARTICLE_TAG = 'EDIT_ARTICLE_TAG';
...
export const CLEAR_ALL_BOARD = 'CLEAR_ALL_BOARD';

export const FETCH_HOT_BOARD = 'FETCH_HOT_BOARD';
export const CLEAR_HOT_BOARD = 'CLEAR_HOT_BOARD';
